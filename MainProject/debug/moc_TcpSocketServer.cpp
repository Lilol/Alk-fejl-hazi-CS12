...
struct qt_meta_stringdata_TcpSocketServer_t {
    QByteArrayData data[4];
    char stringdata[44];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_TcpSocketServer_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TcpSocketServer_t qt_meta_stringdata_TcpSocketServer = {
    {
QT_MOC_LITERAL(0, 0, 15), // "TcpSocketServer"
QT_MOC_LITERAL(1, 16, 13), // "newConnection"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 12) // "disconnected"

    },
    "TcpSocketServer\0newConnection\0\0"
    "disconnected"
};
...
const QMetaObject TcpSocketServer::staticMetaObject = {
    { &TcpCommunication::staticMetaObject, qt_meta_stringdata_TcpSocketServer.data,
      qt_meta_data_TcpSocketServer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TcpSocketServer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TcpSocketServer.stringdata))
        return static_cast<void*>(const_cast< TcpSocketServer*>(this));
    return TcpCommunication::qt_metacast(_clname);
}

int TcpSocketServer::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = TcpCommunication::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 2)
